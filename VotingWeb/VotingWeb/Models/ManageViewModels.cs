...
namespace VotingWeb.Models
{
    ...
    {
        [Required(ErrorMessageResourceName = "VALIDATION_REQUIRED_PASSWORD_OLD", ErrorMessageResourceType = typeof(AccountRes))]
        [DataType(DataType.Password)]
        [Display(Name = "CHANGE_PASSWORD_OLD", ResourceType = typeof(AccountRes))]
        public string OldPassword { get; set; }

        [Required(ErrorMessageResourceName = "VALIDATION_REQUIRED_PASSWORD_NEW", ErrorMessageResourceType = typeof(AccountRes))]
        ...
        [Compare("NewPassword", ErrorMessageResourceName = "VALIDATION_PASSWORD_CONFIRM", ErrorMessageResourceType = typeof(AccountRes))]
        public string ConfirmPassword { get; set; }
    }
